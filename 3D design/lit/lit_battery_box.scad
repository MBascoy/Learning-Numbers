...
module lit_battery_box(){
    ...
    difference(){
        ...
        translate([lit_battery_x + (lit_battery_x_size/2), lit_battery_y + battery_screws_pos, lit_height + battery_height]) cylinder(battery_wall, screw_battery_size, screw_battery_size);
        
        translate([lit_battery_x + (lit_battery_x_size/2), lit_battery_y + battery_screws_pos + battery_screws_spacing, lit_height + battery_height]) cylinder(battery_wall, screw_battery_size, screw_battery_size);
    }
}
